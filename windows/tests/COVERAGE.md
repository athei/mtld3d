...
| `samplers.rs` | State round-trip; CLAMP≠WRAP past the unit square; POINT≠LINEAR; BORDER with a white border colour reads white; a non-preset border colour falls back to opaque black (pinned Metal limitation). |
