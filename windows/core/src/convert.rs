...
use mtld3d_shared::{
    ...
    mtl::{
        ...
        MinMagFilter, MipFilter, PrimitiveType, StencilOp, TriangleFillMode, VertexFormat,
    },
};
use mtld3d_types::{
    ...
    D3DFILL_SOLID, D3DFILL_WIREFRAME, D3DFMT_A1R5G5B5, D3DFMT_A4R4G4B4, D3DFMT_A8, D3DFMT_A8B8G8R8,
    D3DFMT_A8R8G8B8, D3DFMT_A16B16G16R16, D3DFMT_A16B16G16R16F, D3DFMT_A32B32G32R32F,
    D3DFMT_G16R16, D3DFMT_G16R16F, D3DFMT_G32R32F, D3DFMT_L8, D3DFMT_R5G6B5, D3DFMT_R16F,
    D3DFMT_R32F, D3DFMT_X1R5G5B5, D3DFMT_X8B8G8R8, D3DFMT_X8R8G8B8, D3DFVF_DIFFUSE,
...
/// Translate triangle polygon fill without changing the primitive topology.
#[must_use]
pub fn d3d_to_metal_fill(mode: u32) -> TriangleFillMode {
    match mode {
        D3DFILL_SOLID => TriangleFillMode::Fill,
        D3DFILL_WIREFRAME => TriangleFillMode::Lines,
        D3DFILL_POINT => {
            mtld3d_shared::log_once_warn!(target: crate::LOG_TARGET,
                "D3DFILL_POINT has no native Metal polygon fill mode → drawing solid");
            TriangleFillMode::Fill
        }
        _ => {
            mtld3d_shared::log_once_warn!(target: crate::LOG_TARGET,
                "fill mode {mode} unmapped → drawing solid");
            TriangleFillMode::Fill
        }
    }
}
